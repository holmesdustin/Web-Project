<section id="banner">
    <div class="inner">
        ...
        <div class="input-group md-form form-sm form-2 pl-0">
            <input class="form-control" style="font-size:unset; border-right-color: transparent;" id="inputKey"
                type="text" placeholder="Search Movies by Title, Keyword..." aria-label="Search" />
            <button type="button" style="border-left-color: transparent;" id="button"><i class="fas fa-search fa-lg"
                    aria-hidden="true"></i></button>
        </div>

        <br /><br /><br />
        <h3 style="color: #9c9c9c;">
            Supported By: &nbsp;&nbsp;<i class="fab fa-php"></i> &nbsp;&nbsp;&nbsp;<i
