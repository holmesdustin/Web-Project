...
<section id="main" style="background-color: #1c1c1c; color: white;">
    <div class="inner">
        ...
        <h2 class="text-center">We are <strong>Team Gao</strong></h2>
        ...
        <div class="row container-fluid relative">
            <div class="col-xs-12 col-sm-6 col-lg-3">
                <div class="card text-center" style="border-radius: 20px;">
                    <img class="card-img-top" style="border-radius: 20px 20px 0px 0px; background-color:#1c1c1c;" src="https://cdn.pixabay.com/photo/2016/11/29/05/45/astronomy-1867616__340.jpg" alt="Yujing Gao BG">
                    <div class="card-body">
