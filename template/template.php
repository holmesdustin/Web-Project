...
<body>
    <!-- Header -->
    <header id="header">
        <a class="logo" href="../index.php"><i
                class="fas fa-film fa-lg"></i><strong>&nbsp;&nbsp;<?php site_name() ?></strong></a>
    ...
    <!-- Footer -->
    <footer id="footer">
        <a class="weatherwidget-io" href="https://forecast7.com/en/32d46n84d99/columbus/?unit=us"
            data-label_1="Columbus" data-label_2="Weather" data-font="Roboto" data-icons="Climacons Animated"
            data-mode="Both" data-days="7" data-theme="original" data-basecolor="">COLUMBUS WEATHER</a>
        <script>
        ! function(d, s, id) {
