...
function nav_menu()
{
    ...
    foreach ($nav_items as $uri => $name) {
        ...
        $icon = $name == 'Trending' ? '<i class="fas fa-hat-wizard"></i>' : ($name == 'About Us' ? '<i class="fas fa-users"></i>' : ($name == 'Contact Us' ? '<i class="fas fa-paper-plane"></i>' : '<i class="fab fa-fort-awesome-alt"></i>'));
